...
public class PostController {
    ...
    public ResponseEntity<Object> getPerPage(GetPerPageRequest request){
        ...
        Pagination pagination = new Pagination<>(this.paginationResponse.setPagination(listPostPage));
        ApiResponse<List<Post>> response = new ApiResponse<>(listPostPage.toList(), pagination);
